...
- `version` in `runtimeconfig.json` -- This value can be hand-edited. It works and it is fine to do so, but it is a last resort and not considered a first-class option.

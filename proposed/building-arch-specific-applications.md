...
* Self-contained apps are disabled by default unless a RID is specified, at which point self-contained becomes the default. This is an unfortunate behavior. We should fix that for 3.0+ projects.
...
* It is easy and intuitive to share applications with others or deploy them to other machines (like a Raspberry Pi, or a Windows ARM64 laptop) as part of a fluid workflow.

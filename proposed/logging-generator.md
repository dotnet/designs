...
1. We cannot provide event ID through these APIs; it is easier to build queries against log events when analyzing logs later if they are included with IDs.

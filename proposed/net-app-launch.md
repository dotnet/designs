...
Framework-dependent apps do not contain a framework themselves and instead need a separate framework located somewhere on the machine. This is the most complicated scenario with the most configuration options.
